...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void) {
			...
			this->continue_auth->Text = L"Ïðîäîëæèòü";
			...
			this->register_label->Text = L"Çàðåãèñòðèðóéòåñü";
			...
			this->forgot_password->Text = L"Çàáûëè ïàðîëü\?";
			...
			this->label5->Text = L"Íåò àêêàóíòà\?";
			// 
			// label4
			// 
			...
			this->label3->Text = L"Ëîãèí/email";
			// 
			// password_auth
			// 
			...
			this->label2->Text = L"Àâòîðèçèçàöèÿ";
			// 
			// tabPage2
			// 
			...
			this->continue_register->Text = L"Ïðîäîëæèòü";
			...
			this->label12->Text = L"Ïîâòîðèòå ïàðîëü";
			// 
			// label7
			// 
			...
			this->label11->Text = L"Ðåãèñòðàöèÿ";
			// 
			// tabPage3
			// 
			...
			this->continue_recovery->Text = L"Ïðîäîëæèòü";
			...
			this->label9->Text = L"Ëîãèí/email";
			// 
			// data_recovery
			// 
			...
			this->label10->Text = L"Âîññòàíîâëåíèå \r\nïàðîëÿ";
			...
			this->source->Text = L"Èñõîäíûé êîä";
			...
			this->clearServices->Text = L"Î÷èñòèòü ñïèñîê ñåðâèñîâ";
			...
			this->services->Text = L"Ïîëíàÿ èíôîðìàöèÿ î ñåðâèñàõ";
			...
			this->sync->Text = L"Ñèíõðîíèçèðîâàòü âðåìÿ ñ Google";
			...
			this->security->Text = L"Àâòîñîõðàíåíèå äàííûõ: ÂÊË";
			...
			this->import->Text = L"Èìïîðò / Ýêñïîðò äàííûõ";
			...
			this->appinfo->Text = L"Èíôîðìàöèÿ î ïðèëîæåíèè";
			...
			this->editLabel_1->Text = L"Íîâûé ëîãèí:";
			...
			this->timelabel_1->Text = L"21 ñåê.";
			...
			this->addCustomService->Text = L"Äîáàâèòü";
			...
			this->label16->Text = L"Ñåêðåòíûé êëþ÷";
			// 
			// label15
			// 
			...
			this->label6->Text = L"Èìÿ ïîëüçîâàòåëÿ";
			// 
			// EnterManually
			// 
			...
			this->EnterManually->Text = L"Ââåñòè âðó÷íóþ";
			...
			this->ScanQR->Text = L"Ñêàíèðîâàòü QR";
			...
			this->AddService->Text = L"Äîáàâèòü íîâûé ñåðâèñ";
			...
			this->continue_email->Text = L"Ïðîäîëæèòü";
			...
			this->label14->Text = L"Ïîäòâåðæäåíèå\r\nEmail";
			...
			this->label17->Text = L"Òåêóùèå äàííûå:";
			// 
			// loadDB
			// 
			...
			this->loadDB->Text = L"Çàãðóçèòü íàñòðîéêè ñóùåñòâóþùåé";
			...
			this->createDB->Text = L"Ñîçäàòü ðåçåðâíóþ êîïèþ íàñòðîåê ñåðâèñîâ";
...
#pragma endregion
	private: System::Void Main_MouseDown(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) { // Äâèæåíèå îêíà
		this->Capture = false;
		Message m = Message::Create(this->Handle, 0xa1, IntPtr(2), IntPtr::Zero);
		this->WndProc(m);
	}
	private: System::Void exit_Click(System::Object^ sender, System::EventArgs^ e) { // Âûõîä
		Application::Exit();
	}
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) { // Àâòîðèçàöèÿ
		if (login_auth->Text != "" && password_auth->Text != "") {
			try {
				...
				if (response == "INCORRECT")
					info_auth->Text = "Íåâåðíûé ëîãèí è/èëè ïàðîëü";
				else if (response == "ERROR")
					info_auth->Text = "Îøèáêà íà ñòîðîíå ñåðâåðà";
				else {
					info_auth->Text = "Óñïåøíàÿ àâòîðèçàöèÿ";
				...
				info_auth->Text = "Îøèáêà íà ñòîðîíå êëèåíòà";
			}
			...
			info_auth->Text = "Îøèáêà çàïîëíåíèÿ ïîëåé";
	...
	private: System::Void back_Click(System::Object^ sender, System::EventArgs^ e) { // Íàçàä
	...
	private: System::Void continue_recovery_Click(System::Object^ sender, System::EventArgs^ e) { // Âîññòàíîâëåíèå ïàðîëÿ
		if (data_recovery->Text != "") {
			if (label9->Text == "Ëîãèí/email") {
				try {
					...
					if (data == "YES") {
						...
						label9->Text = "Íîâûé ïàðîëü";
						login = data_recovery->Text;
						data_recovery->Text = "";
					} else if (data == "NO")
						info_recovery->Text = "Ïî÷òà ïîëüçîâàòåëÿ íå ïîäòâåðæäåíà";
					else if (data == "INCORRECT")
						info_recovery->Text = "Ïîëüçîâàòåëü íå íàéäåí";
					else if (data == "ERROR")
						info_recovery->Text = "Îøèáêà íà ñòîðîíå ñåðâåðà";
					else
						info_recovery->Text = "Íåèçâåñòíàÿ îøèáêà";
					if (!info_recovery->Visible && data != "YES")
						info_recovery->Visible = true;
				} catch (int ex) {
					info_recovery->Text = "Îøèáêà íà ñòîðîíå êëèåíòà";
					if (!info_recovery->Visible)
						info_recovery->Visible = true;
				}
			} else {
				try {
					...
					if (data == "OK") {
						info_recovery->Text = "Ïèñüìî ñ ïîäòâåðæäåíèåì óñïåøíî îòïðàâëåíî";
						login = "";
					} else if (data == "INCORRECT")
						info_recovery->Text = "Ïîëüçîâàòåëü íå íàéäåí";
					else if (data == "ERROR")
						...
						info_recovery->Text = "Ïî÷òîâûé àäðåñ íå íàéäåí";
					else
						info_recovery->Text = "Íåèçâåñòíàÿ îøèáêà";
				} catch (int ex) {
					info_recovery->Text = "Îøèáêà íà ñòîðîíå êëèåíòà";
	...
	private: System::Void Main_Load(System::Object^ sender, System::EventArgs^ e) { // Çàãðóçêà ôîðìû
		...
		password = configFile->AppSettings->Settings["password"]->Value; // Çàãðóçêà íàñòðîåê ïðîãðàììû
		if (login != "" && password != "" && remember && isAuthed) { // Ïðîâåðêà ëîãèíà è ïàðîëÿ
	...
	private: System::Void Main_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e) { // Çàêðûòèå ôîðìû
		auto configFile = ConfigurationManager::OpenExeConfiguration(ConfigurationUserLevel::None);
		...
		configFile->Save(ConfigurationSaveMode::Modified); // Ñîõðàíåíèå íàñòðîåê
		if (!isAuthed && user != nullptr)
			File::WriteAllText(System::Environment::GetFolderPath(System::Environment::SpecialFolder::ApplicationData) +
				"\\GoogleAuthetificator\\Data.json", JsonConvert::SerializeObject(user));
	}
	private: System::Void continue_register_Click(System::Object^ sender, System::EventArgs^ e) { // Ðåãèñòðàöèÿ
		if (login_register->Text != "" && password_register->Text != "" && password_register->Text == password_register2->Text) {
			try {
				...
				if (response == "INCORRECT")
					info_register->Text = "Íåâåðíûé ôîðìàò äàííûõ";
				else if (response == "EXISTS")
					info_register->Text = "Óêàçàííûé ëîãèí çàíÿò";
				else if (response == "ERROR")
					info_register->Text = "Îøèáêà íà ñòîðîíå ñåðâåðà";
				else {
				...
				info_register->Text = "Îøèáêà íà ñòîðîíå êëèåíòà";
			}
		} else {
			info_register->Text = "Îøèáêà çàïîëíåíèÿ ïîëåé";
			if (!info_register->Visible)
				info_register->Visible = true;
		}
	}
	private: System::Void continue_email_Click(System::Object^ sender, System::EventArgs^ e) { // Ïîäòâåðæäåíèå ïî÷òû
		if (login != "" && password != "" && email->Text != "") {
			try {
				if (continue_email->Text == "Ïðîäîëæèòü") {
					auto response = sendRequest(host + "/User/Mail/sendLink.php?login=" + login + "&password=" + password + "&email=" + email->Text);
					if (response == "OK")
						continue_email->Text = "Ïðîâåðèòü";
					else if (response == "INCORRECT")
						info_email->Text = "Íåâåðíûé ëîãèí è/èëè ïàðîëü";
					else if (response == "EXISTS")
						info_email->Text = "Ïî÷òîâûé ÿùèê óæå ïðèâÿçàí";
					else if (response == "ERROR")
						info_email->Text = "Îøèáêà íà ñòîðîíå ñåðâåðà";
					else
						info_email->Text = "Íåèçâåñòíàÿ îøèáêà";
				} else {
					auto data = sendRequest(host + "/User/Mail/check.php?login=" + login);
					if (data == "YES")
						tabControl1->SelectedIndex = 4;
					else if (data == "NO")
						info_email->Text = "Ïî÷òà ïîëüçîâàòåëÿ íå ïîäòâåðæäåíà";
					else if (data == "INCORRECT")
						info_email->Text = "Ïîëüçîâàòåëü íå íàéäåí";
					else if (data == "ERROR")
						info_email->Text = "Îøèáêà íà ñòîðîíå ñåðâåðà";
					else
						info_email->Text = "Íåèçâåñòíàÿ îøèáêà";
				...
				info_email->Text = "Îøèáêà íà ñòîðîíå êëèåíòà";
			}
			if (info_email->Text != "label11")
				info_email->Visible = true;

		} else 
			info_email->Text = "Îøèáêà çàïîëíåíèÿ ïîëåé";
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		if (authpanel_1->Visible) {
			timelabel_1->Text = seconds_remain.ToString() + " ñåê.";
		}
		for each (Control^ panel in elementpanel->Controls)
		{
			if (panel->GetType() == (gcnew Panel)->GetType() && panel->Visible && panel->Name->Contains("_") && !panel->Name->StartsWith("editPanel_")) {
				...
				try {
					panel->Controls["timelabel_" + number]->Text = seconds_remain.ToString() + " ñåê.";
				} catch (int ex) {}
			}
		}
	...
	private: System::Void tabControl1_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e) {
		...
		if (tabControl1->SelectedIndex == 4) {
			...
			timer1->Stop();
			if (tabControl1->SelectedIndex == 3)
				security->Text = "Àâòîñîõðàíåíèå äàííûõ: " + (remember ? "ÂÊË" : "ÂÛÊË");
			else if (tabControl1->SelectedIndex == 6) {
				servicesBox->Text = "";
				for each (App^ app in user->Applications) {
					servicesBox->Text += "Ñåðâèñ: " + app->Site + "\n";
					servicesBox->Text += "Èìÿ ïîëüçîâàòåëÿ: " + app->Login + "\n";
					servicesBox->Text += "Ñåêðåòíûé êëþ÷: " + app->Secret + "\n";
					servicesBox->Text += "Êîä: " + app->Code + "\n";
					servicesBox->Text += "Ññûëêà íà QR êîä: " + app->QR + "\n\n";
				}
	...
	private: System::Void security_Click(System::Object^ sender, System::EventArgs^ e) {
		try {
			remember = !remember;
			security->Text = security->Text->Replace(remember ? "ÂÛÊË" : "ÂÊË", remember ? "ÂÊË" : "ÂÛÊË");
		} catch (int ex) {}
	}
	};
}
